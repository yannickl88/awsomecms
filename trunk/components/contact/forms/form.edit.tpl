...
{/if}
<form method="post" action="/" class="admin_form admin_contact_edit" onsubmit="return prossesFields();">
    <div class="admin_form_row">
        <div class="admin_form_label">
            <label for="form_name">Name:</label>
        </div>
        <div class="admin_form_field">
            <input type="text" name="form_name" id="form_name" value="{$record->form_name}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            <input type="text" name="form_to" id="form_to" value="{$record->form_to}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            <input type="text" name="form_bcc" id="form_bcc" value="{$record->form_bcc}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            <input type="text" name="form_subject" id="form_subject" value="{$record->form_subject}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            ...
            <input type="text" name="form_thanks" id="form_thanks" value="{$record->form_thanks}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            <table id="form_fields">
                ...
                {foreach from=$record->fields item=field name=fields}
                    <tr class="fieldrow">
                        <td>
                        ...
                        <td>
                            <input type="text" class="field_sort tinyfield" value="{$smarty.foreach.fields.index+1}"/>
                        </td>
                        <td>
                            <a href="javascript: void(0)"><img src="/img/icons/cross.png" id="deleteIcon" onclick="deleteFieldsRow({$smarty.foreach.fields.index})"/></a>
                        </td>
                    </tr>
                {/foreach}
            </table>
    ...
    <input type="hidden" name="form_id" value="{$record->form_id}" />
