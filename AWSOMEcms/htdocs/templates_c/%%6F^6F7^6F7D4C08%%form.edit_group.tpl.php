<?php /* Smarty version 2.6.22, created on 2009-09-20 12:20:15
         compiled from file:D:%5Cwww%5Cskimfo%5Ccomponents%5Cslideshow/forms/form.edit_group.tpl */ ?>
...
<form method="post" action="/" class="admin_form admin_slideshow_group_add" enctype="multipart/form-data">
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <input type="text" name="group_title" id="group_title" value="<?php echo $this->_tpl_vars['record']->group_title; ?>
"/>
        </div>
    </div>
    <div class="admin_form_row">
    ...
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <ul id="group_images">
                <?php $_from = $this->_tpl_vars['groupimages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['image']):
?>
                <li id="image<?php echo $this->_tpl_vars['image']->image_id; ?>
">
                    <a href="javascript: removeImage(<?php echo $this->_tpl_vars['image']->image_id; ?>
);">
                        <img src="/img/icons/image_delete.png">
                    </a>
                    <?php echo $this->_tpl_vars['image']->image_title; ?>

                    <input name="images[]" value="<?php echo $this->_tpl_vars['image']->image_id; ?>
" type="hidden">
                </li>
                <?php endforeach; endif; unset($_from); ?>
            </ul>
...
"><?php echo $this->_tpl_vars['image']->image_title; ?>
    ...
    <input type="hidden" name="group_id" value="<?php echo $this->_tpl_vars['record']->group_id; ?>
" />
