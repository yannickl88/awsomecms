<?php /* Smarty version 2.6.22, created on 2009-09-19 14:23:39
         compiled from file:D:%5Cwww%5Cskimfo%5Ccomponents%5Cslideshow/forms/form.add.tpl */ ?>
...
"/>
    ...
    <div class="admin_form_row">
        <div class="admin_form_label">
            <label for="image_groups">Groups:</label>
        </div>
        <div class="admin_form_field">
            <ul>
                <li></li>
