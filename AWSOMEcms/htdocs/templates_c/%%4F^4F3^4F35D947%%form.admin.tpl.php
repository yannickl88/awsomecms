<?php /* Smarty version 2.6.22, created on 2009-09-12 00:35:39
         compiled from file:D:%5Cwww%5Cskimfo%5Chtdocs%5Ccomponents%5Ccontact/forms/form.admin.tpl */ ?>
...
?>
    <tr class="admin_table_row <?php if (($this->_foreach['admin']['iteration']-1)%2 == 1): ?>highlighted<?php endif; ?>">
        <td class="admin_table_cell">
            <?php echo $this->_tpl_vars['row']->form_name; ?>

        </td>
        <td class="admin_table_cell">
            <?php echo $this->_tpl_vars['row']->form_subject; ?>

        </td>
        <td class="admin_table_cell admin_table_actions">
            <a href="/<?php echo $this->_tpl_vars['actionurl_edit']; ?>
&form_id=<?php echo $this->_tpl_vars['row']->form_id; ?>
"><img src="/img/icons/form_edit.png" alt="edit"></a>
            <a href="/<?php echo $this->_tpl_vars['actionurl_delete']; ?>
&form_id=<?php echo $this->_tpl_vars['row']->form_id; ?>
"><img src="/img/icons/form_delete.png" alt="delete"></a>
        </td>
        <td class="admin_table_cell admin_table_actions">
            <input type="checkbox" value="<?php echo $this->_tpl_vars['row']->form_id; ?>
...
', 'form_id', $('.actioncheckbox'));"><img src="/img/icons/page_white_delete.png" alt="deleteselected"></a>
        </td>
    </tr>
</table>