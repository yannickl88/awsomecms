<?php /* Smarty version 2.6.22, created on 2009-09-12 13:03:01
         compiled from file:D:%5Cwww%5Cskimfo%5Ccomponents%5Cgallery/forms/form.edit.tpl */ ?>
...
"/>
    ...
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <input type="text" name="image_tag" id="image_tag" value="<?php echo $this->_tpl_vars['record']->image_tag; ?>
"/>
        </div>
    </div>
