<?php /* Smarty version 2.6.22, created on 2009-09-12 00:35:41
         compiled from file:D:%5Cwww%5Cskimfo%5Chtdocs%5Ccomponents%5Cpage/forms/form.add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'admintree', 'file:D:\\www\\skimfo\\htdocs\\components\\page/forms/form.add.tpl', 27, false),)), $this); ?>
...
<form method="post" action="/" class="admin_form admin_page_add">
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <input type="text" name="page_name" id="page_name" value="<?php echo $this->_tpl_vars['FORMERROR']['record']['page_name']; ?>
"/>
        </div>
    </div>
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            ...
            <input type="text" name="page_location" id="page_location" value="<?php echo $this->_tpl_vars['FORMERROR']['record']['page_location']; ?>
"/>
        </div>
    </div>
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <textarea name="page_template" id="page_template" rows="5" cols="20"><?php echo $this->_tpl_vars['FORMERROR']['record']['page_template']; ?>
</textarea>
        </div>
    </div>
