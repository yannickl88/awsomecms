...
<form method="post" action="/" class="admin_form admin_page_add">
    <div class="admin_form_row">
        ...
        <div class="admin_form_field">
            <input type="text" name="page_name" id="page_name" value="{$record->page_name}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            ...
            <input type="text" name="page_location" id="page_location" value="{$record->page_location}"/>
        </div>
    </div>
    <div class="admin_form_row">
        <div class="admin_form_label">
        ...
        <div class="admin_form_field">
            <textarea name="page_template" id="page_template" rows="20" cols="20" class="htmleditor">{$record->page_template}</textarea>
        </div>
    </div>
